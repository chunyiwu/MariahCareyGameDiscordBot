...
# game time
game_year   = 2022      # year of the game
...
async def reset_inf():
    ...
    await chans[iichan_inf].send(\
        ...
        "Video: <https://www.youtube.com/watch?v=3HeyQFCRtqg>\n" +\
        "Document: <https://docs.google.com/document/d/1dq8xRoP6fDE4Aga3oyPkhURIaLTHXntMbE3VEF0RF8Q/edit?usp=sharing>", file=discord.File("pics/rule.png"))
...
async def phase_game_end():
    ...
    text += strL[2:] + " lost, and " + strW[2:] + " won!\n"
